...
if __name__ == "__main__":
    url_1 = "https://api.github.com/Zhenyu-Zhao98"
    kobe = requests.get(url_1)
    if kobe.status_code!=404:
    	r = requests.get(url_1)
    	print(r.status_code)
    	print(r.json())
    
    url_2 = "https://api.github.com/users/Zhenyu-Zhao98"
    kobe = requests.get(url_2)
    if kobe.status_code!=404:
